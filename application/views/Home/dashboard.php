      ...
      <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
        <div class="inner">
          <div class="app-card-body p-3 p-lg-4">
            <h3 class="mb-3 text-capitalize">Welcome, <?= $user['nama_lengkap']; ?></h3>
            <div class="row gx-5 gy-3">
              <div class="col-12 col-lg-9">

                <div>Selamat datang di website pendataan penduduk desa Bulu Apo.</div>
              </div>
            </div>
      ...
      <div class="row g-4 mb-4">
        <div class="col-6 col-lg-3">
          <div class="app-card app-card-stat shadow-sm h-100">
            <div class="app-card-body p-3 p-lg-4">
              <h4 class="stats-type mb-1">Total Penduduk</h4>
              <div class="stats-figure"><?= $totalPenduduk; ?></div>
            </div>
